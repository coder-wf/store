...
<html>
	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="active">
								...
								<td>
									<a href="javascript:void(0);" class="delete" onclick="deleteByPid('${ci.product.pid}')">删除</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">${cart.total }</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${cart.total }.00元</strong>
				</div>
	...
	<script type="text/javascript">
		function deleteByPid(pid) {
			...
			if(flag){
				//通过js的location.href = "";
				location.href = "${pageContext.request.contextPath}/cartServlet?method=removeFromCart&pid="+pid;
			}
		}
	</script>
